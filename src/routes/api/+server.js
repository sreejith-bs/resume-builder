    ...
    const query = e.params({ items: e.json }, (params) => {
      return e.for(e.json_array_unpack(params.items), (item) => {
        return e.insert(e.UserDetails, {
          ...
          date_of_birth: item.date_of_birth ? e.cast(e.str, item.date_of_birth) : '',
          ...
          experience: e.for(e.json_array_unpack(item.experience), (expItem) => {
            return e.insert(e.Experience, {
              ...
              start_date: expItem.start_date ? e.cast(e.str, expItem.start_date) : '',
              end_date: expItem.end_date ? e.cast(e.str, expItem.end_date): '',
          ...
          education: e.for(e.json_array_unpack(item.education), (eduItem) => {
            return e.insert(e.Education, {
              ...
              start_date: eduItem.start_date ? e.cast(e.str, eduItem.start_date) : '',
              end_date: eduItem.end_date? e.cast(e.str, eduItem.end_date) : '',
